...
* **CGAL Alpha Wrapping**: Uses [CGAL Alpha Wrapping](https://doc.cgal.org/latest/Alpha_wrap_3) to generate cleaner and more uniform topology.
...
![Screenshot of CAD Simplifier Interface](UI_Demo.png)
...
1.  **Clone the Repository**
    ```bash
    git clone [https://github.com/jaiecodes/CADSimplifyApp.git](https://github.com/jaiecodes/CADSimplifyApp.git)
    cd simplifyapp
    ```
