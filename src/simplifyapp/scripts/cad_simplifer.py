...
def run_simplifer(model_path, export_dir, logger):
    ...
    wrapped_path_1 = run_alpha_wrap(model_path, export_dir, logger, relative_alpha=500.0, relative_offset=6500.0)

    print("[CAD Simplifier] Running second alpha wrap...")
    logger("[CAD Simplifier] Running second alpha wrap...")
    wrapped_path_2 = run_alpha_wrap(wrapped_path_1, export_dir, logger, relative_alpha=300.0, relative_offset=6000.0)
